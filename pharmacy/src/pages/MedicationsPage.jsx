...
export default function MedicationsPage() {
  ...
  const filtered = rawMedicines.filter((pharmacyMed) => {
    ...
    const matchType =
      selectedType === "جميع الأنواع" || med.type === selectedType;
          ...
          <>
              ...
              <table className="w-full text-sm text-right min-w-[800px]">
                <thead>
                  <tr style={{ background: "#55B1A5" }} className="text-white">
                    <th className="px-5 py-4 font-semibold text-right w-[22%]">
                      الدواء
                    </th>
                      ...
                      <tr
                          ...
                          <div className="flex items-center gap-3 justify-start">
                            <div className="w-9 h-9 rounded-lg bg-gray-50 border border-gray-100 flex items-center justify-center shrink-0">
                              <img
                                src={
                                  med.images?.[0] ||
                                  "https://cdn-icons-png.flaticon.com/128/4766/4766295.png"
                                }
                                alt={med.englishName}
                            ...
                            <div className="flex flex-col min-w-0 text-right">
                              <span
                                className="font-bold text-text text-[13px] leading-tight truncate"
                                dir="ltr">
                                {med.englishName}
                              </span>
                        ...
                        <td className="px-4 py-3 text-center">
                          <span
                            ...
                            style={{
                              background:
                                TYPE_COLOURS[med.type]?.bg || "#E8F8F5",
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <button
                              onClick={() =>
                                setSelectedMedToUpdate({
                                  ...med,
                                  price: pharmacyMed.price,
                                  pharmacyMedId: med._id,
                                })
                              }
            ...
            <div className="md:hidden flex flex-col divide-y divide-gray-100">
              {currentMeds.map((pharmacyMed) => {
                const med = pharmacyMed.medicine;
                const tc = TYPE_COLOURS[med.type] || {
                  bg: "#E8F8F5",
                  text: "#2DB89E",
                };
                return (
