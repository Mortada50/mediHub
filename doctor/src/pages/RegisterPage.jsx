...
function RegisterPage() {
  ...
  const STEPS = update
    ? ["الحساب", "المعلومات المهنية"]
    : ["الحساب", "المعلومات المهنية", "تأكيد الإيميل"];
  ...
  const validateStep1 = () => {
    ...
    if (!e.fullName && !/^[A-Za-z\u0600-\u06FF\s]+$/.test(form.fullName)) {
      
      e.fullName = "لا يجب أن يحتوي الاسم على أرقام أو رموز";
    }
            ...
            <div className="flex flex-col gap-3 items-start pt-5 w-full">
              ...
              <div className="flex flex-col gap-1 w-full">
                ...
                <select
                  ...
                  className={`h-[55px] w-full text-primary bg-background-primary rounded-lg py-2 px-4 border focus:outline-none text-sm ${
                    error.speciality ? "border-red-400" : "border-transparent"
                  }`}>
                  <option value="" disabled>
                    اختر تخصصك
                  </option>
                ...
                {error.speciality && <InputsError error={error.speciality} />}
              </div>
              ...
              <div className="flex flex-col gap-1 w-full">
                ...
                <textarea
                  ...
                  rows={3}
                  className={`w-full bg-background-primary rounded-lg py-3 px-4 border text-gray-700 focus:outline-none placeholder:text-sm resize-none  text-sm ${
                ...
                />
                {error.qualifications && (
                  <InputsError error={error.qualifications} />
                )}
              </div>
              ...
              <div className="flex flex-col gap-1 w-full">
                ...
                <input
                  ...
                  className={`h-[55px] w-full bg-background-primary rounded-lg py-2 px-4 border focus:outline-none placeholder:text-sm text-gray-700 ${
                    error.clinicName ? "border-red-400" : "border-transparent"
                  }`}
                />
                {error.clinicName && <InputsError error={error.clinicName} />}
              </div>
